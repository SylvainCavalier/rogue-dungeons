...
ActiveRecord::Schema[8.0].define(version: 2026_02_21_031112) do
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.integer "current_mana", default: 0, null: false
    t.integer "max_mana", default: 0, null: false
    t.integer "xp", default: 0, null: false
    t.integer "gold", default: 50, null: false
  ...
  create_table "inventory_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_id", "item_key"], name: "index_inventory_items_on_character_id_and_item_key"
    t.index ["character_id"], name: "index_inventory_items_on_character_id"
  end

  create_table "learned_magics", force: :cascade do |t|
    t.bigint "character_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_id", "magic_key"], name: "index_learned_magics_on_character_id_and_magic_key", unique: true
    t.index ["character_id"], name: "index_learned_magics_on_character_id"
  end

  create_table "learned_techniques", force: :cascade do |t|
    t.bigint "character_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_id", "technique_key"], name: "index_learned_techniques_on_character_id_and_technique_key", unique: true
  ...
  create_table "skills", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.string "category", null: false
    t.integer "mastery", default: 1, null: false
